              ...
              >
                <div className="flex flex-col items-center justify-center">
                  ...
                  <div className="w-full p-1 group-hover:opacity-100">
                    <div className="ml-2 rounded-t-md bg-white bg-gradient-to-r from-yellow-500 to-yellow-900 px-1 text-center text-lg font-medium tracking-tight text-white">
                      {member.name}
                    </div>
                    <div className="text-normal boder-black ml-2 rounded-b-md border bg-white text-center font-light tracking-tight text-yellow-800">
                      {member.position}
                    </div>
                  </div>
                </div>
